...
<body>
    ...
    <form  name="formUpdate" action="Update_producto.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" name="PrecioVenta" required value="<?php echo $PrecioVenta ?>">
        </div>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
        <button id="aceptar" type="submit">Guardar</button>
